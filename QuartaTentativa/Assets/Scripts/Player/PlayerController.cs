...
public class PlayerController : MonoBehaviour
{
	...
	void FixedUpdate ()
    {
        ...
        Vector3 VectorXY = new Vector3(moveX, moveY, 0);
        VectorXY = VectorXY.normalized * Speed * Time.deltaTime;
        PlayerBody.MovePosition(PlayerBody.transform.position + VectorXY);
